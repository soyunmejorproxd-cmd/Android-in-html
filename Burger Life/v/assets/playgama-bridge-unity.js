...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/6f80bcc7f6af359737a278f20baa23cf.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/52cd144de21b665b1e442100b2c91f7d.data.unityweb',
                        frameworkUrl: 'Build/2e7efc67fd31182acb2e72a9426d7531.framework.js.unityweb',
                        codeUrl: 'Build/80f812359ad6b4f1954bc219db099ea4.wasm.unityweb',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'GMR Bros',
                        productName: 'Burger Life',
